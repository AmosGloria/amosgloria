...
export default function App() {
  ...
  return (   
    <BrowserRouter>
       <div className="h-full bg-[#ABB2BF] dark:bg-[#282C33] dark:text-[#ABB2BF] text-[#282C33] transition-colors duration-300">
        <div className='flex justify-between px-10 items-center font-bold'>
